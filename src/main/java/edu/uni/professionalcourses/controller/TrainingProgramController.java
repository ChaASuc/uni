...
public class TrainingProgramController {
    ...
    @GetMapping(value = "/trainingProgram/listBySpecialtyId/{SpecialtyId}")
    public void list(
...
//        String cacheName = CacheNameHelper.List_CacheNamePrefix + pageNum;
        String json;
//        if(json == null){
            List<TrainingProgram> trainingPrograms = trainingProgramService.selectBySpecialtyId(SpecialtyId);
            json = Result.build(ResultType.Success).appendData("trainingPrograms", trainingPrograms).convertIntoJSON();
